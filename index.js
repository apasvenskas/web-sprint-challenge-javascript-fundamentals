...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/* the nestedFunction can access variable internal do to scope and closure. Variable internal is part of myFunction same as nested function. 
functions can acces itmes outised the scope, but not in inside past the closure. */
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    const avrAnimalPop = array.reduce((total, item) => {
